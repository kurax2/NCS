...
public class HREmployeeController {
	...
	@PutMapping("/employee/{searchEmpId}/bank")
	public Employee updateEmployeeBank(@PathVariable int searchEmpId,@RequestParam int bankId)
	{
		return empService.updateProject(searchEmpId, bankId);
	}
	/*@GetMapping("/employee/employee{id}/project/")
	public Employee getEmployeeByProjectId(@PathVariable int id,@RequestParam int projectid)
	{
		System.out.println("path varible : "+id+projectid);
		if(empService.getEmployeeDetails(id)) {
			return empService.g
		}
	}*/
